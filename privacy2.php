...
<body>
    ...
    <div class="container mrg">
        <div class="jumbotron">
            ...
            <a class="pass li" href="edit.php">Edit profile</a> <br>
            <img src="img/cp2.png" class="pr" alt="">
            <a class="pass li" href="cpass2.php">Change Password</a> <br>
            <img src="img/dl1.png" class="pr" alt="">
            <a class="pass li" href="delete2.php">Delete Account</a> <br>
