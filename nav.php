              ...
              <div class="navbar-nav ms-auto">
                ...
                <div class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu rounded-0 m-0">
                    <a href="search.php" class="dropdown-item">Home</a>
                    <a href="search.php" class="dropdown-item">Flat</a>
                    <a href="search.php" class="dropdown-item">Office</a>
                    <a href="search.php" class="dropdown-item">Rooms</a>
                  </div>
                </div>
                <div class="nav-item dropdown">
                  <a
                ...
                <a href="#Agent" class="nav-item nav-link">Contact</a>
              </div>
              <a href="package2.php" class="btn btn-primary px-3 d-none d-lg-flex" style="
    font-size: 1rem;"
                >Explore</a>
            </div>
